...
export default function ProfileScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Error",
        error.msg || error.message || "Failed to update profile.",
      );
    }
  };
  ...
  const currentDisplayImage =
    pendingImage && pendingImage !== "delete"
      ? pendingImage
      : pendingImage === "delete"
        ? null
        : image;
              ...
              {currentDisplayImage ? (
                ...
                <View
                  style={[
                    ...
                    {
                      backgroundColor:
                        colorScheme === "dark" ? "#2C2C2E" : "#E0E0E0",
                    },
                  ]}
                >
        ...
        >
          ...
          <View
            style={[
              ...
              styles.readOnlyItem,
              {
                backgroundColor: colorScheme === "dark" ? "#2C2C2E" : "#EAEAEA",
              },
            ]}
          >
          ...
          <View style={styles.editItem}>
            ...
            <TextInput
              style={[
                styles.input,
                { color: theme.text, borderBottomColor: "#00B1EB" },
              ]}
              value={fullname}
