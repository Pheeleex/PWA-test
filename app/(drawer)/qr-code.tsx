      ...
      <View style={styles.content}>
        ...
        <View
          style={[
            ...
            {
              backgroundColor:
                colorScheme === "dark" ? "rgba(255,255,255,0.05)" : "#F8FAFC",
            },
          ]}
        >
          <Ionicons
          ...
          <Text style={[styles.disclaimerText, { color: "#64748B" }]}>
            Nur für erwachsene Raucher/innen – wenn Du jünger als 25 Jahre
            aussiehst, ist die Vorlage eines Ausweises erforderlich.
          </Text>
        </View>
      </View>
    </View>
